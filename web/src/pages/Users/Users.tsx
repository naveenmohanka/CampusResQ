...
import { UserFilters, UserProfile, UserRole } from '../../types/user';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-400 mt-1">
            Manage student registrations, mentor emergency leads, and security administrators.
          </p>
        </div>
      </div>
