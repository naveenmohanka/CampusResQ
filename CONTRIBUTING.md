...
1. **Main Branch**: The `main` branch is protected and contains stable, production-ready releases.
...
- Ensure Firestore Security Rules enforce strict role-based access before deploying.
